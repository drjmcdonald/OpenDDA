...
/* Plan creation for the DFT of the tensor components */
      ...
      plan_tcydft=fftwf_plan_many_dft(1,&target.Jpp,target.Ka,(fftwf_complex *)(&interaction_matrix[0]),NULL,target.Ka,1,(fftwf_complex *)(&interaction_matrix[0]),NULL,target.Ka,1,-1,FFTW_MEASURE);
