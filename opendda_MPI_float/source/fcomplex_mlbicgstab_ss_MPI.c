...
void fcomplex_mlbicgstab_ss_MPI(void){

   int i,ii,s,t,vc,iteration=0;
   long int index0i,array0,array1,array2;
   fcomplex alpha,rho,tempdc,tempe,beta,reduce;
...
/* ->->->->->->->->->->->->->->->->->->->->->->->->->->->->->->->->->->->-> */
/* 3. g[0]=r */
      memcpy(g,r,(size_t)parallel.alloc_vector3*sizeof(fcomplex));
   }
...
/* 5. c[0]=q[0]^{H}omega[0] */
   reduce=zero;
   for(index0i=0;index0i<parallel.alloc_vector3;index0i++){
      reduce=fcomplex_add(reduce,fcomplex_mul(fcomplex_conj(q[index0i]),omega[index0i]));
   }
   MPI_Allreduce(&reduce,&c[0],1,fcomplex_type,add_fcomplex,MPI_COMM_WORLD);
...
/* ->->->->->->->->->->->->->->->->->->->->->->->->->->->->->->->->->->->-> */
/* 9. zomega=r,zg=0 */
         memcpy(zomega,r,(size_t)parallel.alloc_vector3*sizeof(fcomplex));
         for(index0i=0;index0i<parallel.alloc_vector3;index0i++){
            zg[index0i]=zero;
         }
...
/* tempe=q[ii]^{H}r */
         ...
         for(vc=0;vc<3;vc++){
            ...
            for(index0i=0;index0i<parallel.alloc_vector;index0i++){
               array2=array0+index0i;
               reduce=fcomplex_add(reduce,fcomplex_mul(fcomplex_conj(q[array1+index0i]),r[array0+index0i]));
            }
         }
         MPI_Allreduce(&reduce,&tempe,1,fcomplex_type,add_fcomplex,MPI_COMM_WORLD);
...
/* ->->->->->->->->->->->->->->->->->->->->->->->->->->->->->->->->->->->-> */
/* 18. g[ii]=zg */
         memcpy(&g[ii*parallel.alloc_vector3],zg,(size_t)parallel.alloc_vector3*sizeof(fcomplex));

/* ->->->->->->->->->->->->->->->->->->->->->->->->->->->->->->->->->->->-> */
/* 19. omega[ii]=zomega */
         memcpy(&omega[ii*parallel.alloc_vector3],zomega,(size_t)parallel.alloc_vector3*sizeof(fcomplex));
...
/* 20. c[ii]=q[ii]^{H}zomega */
         ...
         MPI_Allreduce(&reduce,&c[ii],1,fcomplex_type,add_fcomplex,MPI_COMM_WORLD);
      } /* End ii for loop */
...
/* 25. rho=(-[interaction_matrix*M^{-1}r]^{H}r)/(||interaction_matrix*M^{-1}r||^2)=
         ...
         reduce=zero;
         for(index0i=0;index0i<parallel.alloc_vector3;index0i++){
            reduce=fcomplex_add(reduce,fcomplex_mul(fcomplex_conj(zomega[index0i]),zomega[index0i]));
         }
         MPI_Allreduce(&reduce,&tempdc,1,fcomplex_type,add_fcomplex,MPI_COMM_WORLD);
         /* Check for iterative.breakdown */
...
/* rho=[interaction_matrix*M^{-1}r]^{H}r */
         reduce=zero;
         for(index0i=0;index0i<parallel.alloc_vector3;index0i++){
            reduce=fcomplex_add(reduce,fcomplex_mul(fcomplex_conj(zomega[index0i]),r[index0i]));   
         }
...
/* 35. g[0]=zg,omega[0]=zomega */
      memcpy(g,zg,(size_t)parallel.alloc_vector3*sizeof(fcomplex));
      memcpy(omega,zomega,(size_t)parallel.alloc_vector3*sizeof(fcomplex));
      iteration++;
