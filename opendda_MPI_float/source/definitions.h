...
extern int polarisation_state,polarisations,DBLP,FLTP;
...
extern fcomplex *interaction_matrix,*interaction_matrix_diagonal,*point_jacobi,*xdft,*zdft;
extern fcomplex *xzscratch,two,one,onei,zero,minusone;
...
extern MPI_Op add_fcomplex; /* User-defined MPI function to add complex_numbers */
/* Iterative vectors */
