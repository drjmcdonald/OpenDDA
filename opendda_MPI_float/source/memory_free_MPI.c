...
void memory_free_MPI(void){
   ...
   fcomplex_fftwf_free(&xdft);  /* xdft[Kpp] */
   fcomplex_fftwf_free(&zdft);  /* zdft[Ppp] */

   /* Scratch array for the DFT, FD multiplication & iDFT of the 3 zero-padded vector components */
   fcomplex_fftwf_free(&xzscratch); /* xzscratch[3*Qpp] */
   ...
   fcomplex_free(&parallel.local_tensor); /* Temporary scratch array for local transpose */
   fcomplex_free(&parallel.local_padded); /* Temporary scratch array for local transpose */
