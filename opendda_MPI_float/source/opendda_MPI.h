/* Written by James Mc Donald 2006
   ...
   Note: see definitions.h for an expfanation of the variables
...
/* Function prototypes */
void initialise(int flag,int *list_length,float *limits);

/* Global variables */
int wl,er,f0,t0,p0,degree,dft_interaction_matrix_flag=0;
int polarisation_state,polarisations,DBLP,FLTP;
float size_parameter,wavenumber,wavenumber_previous=-1.0F;
fcomplex *dipole_polarisation,*incident_E_field,*zero_padded_vector;
fcomplex *interaction_matrix,*interaction_matrix_diagonal,*point_jacobi,*xdft,*zdft;
fcomplex *xzscratch,two={{2.0F,0.0F}},one={{1.0F,0.0F}},onei={{0.0F,1.0F}},zero={{0.0F,0.0F}},minusone={{-1.0F,0.0F}};
fftwf_plan plan_vcxdft,plan_vcydft,plan_vczdft,plan_vcxdfti,plan_vcydfti,plan_vczdfti;
fftwf_plan plan_tcxdft,plan_tcydft,plan_tczdft;
...
MPI_Op add_fcomplex; /* User-defined MPI function to add complex_numbers */
/* Iterative vectors */
fcomplex *c,*d,*g,*gam,*gamp,*gampp,*gtilde,*omega,*omegatilde,*p,*pold,*ptilde,*q;
fcomplex *r,*rtilde,*s,*sigma,**tau,*u,*utilde,*v,*vtilde,*ya,*yb,*zd,*zg,*zomega;
