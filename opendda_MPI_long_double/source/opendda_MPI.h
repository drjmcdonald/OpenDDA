...
ldcomplex *interaction_matrix,*interaction_matrix_diagonal,*point_jacobi,*xdft,*zdft;
ldcomplex *xzscratch,two={{2.0L,0.0L}},one={{1.0L,0.0L}},onei={{0.0L,1.0L}},zero={{0.0L,0.0L}},minusone={{-1.0L,0.0L}};
...
MPI_Op add_ldcomplex; /* User-defined MPI function to add complex_numbers */
/* Iterative vectors */
