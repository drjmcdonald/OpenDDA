   ...
   *file_ptr=fopen(file_string,"r"); /* Reopen the data file for reading */
   ...
   while((fgets(string,sizeof(string),*file_ptr))!=NULL){
      if(string[0]=='#'){continue;} /* Ignore comments */
         ...
         ((*structure_ptr).list)[count]=(long double)atof(string); /* string to long long double conversion */
   ...
   *file_ptr=fopen(file_string,"r"); /* Reopen the data file for reading */
   ...
   while((fgets(string,sizeof(string),*file_ptr))!=NULL){
      if(string[0]=='#'){continue;} /* Ignore comments */
         ...
         ((*structure_ptr).wavelengths[material])[count]=(long double)atof(compare); /* string to long long double conversion */
