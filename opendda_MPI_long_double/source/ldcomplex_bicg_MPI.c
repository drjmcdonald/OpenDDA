...
/* 5. rhok=r^{T}rtilde */
      reduce=zero;
      for(index0i=0;index0i<parallel.alloc_vector3;index0i++){
         reduce=ldcomplex_add(reduce,ldcomplex_mul(r[index0i],rtilde[index0i]));
      }
...
/* ->->->->->->->->->->->->->->->->->->->->->->->->->->->->->->->->->->->-> */
/* 7. ptilde=rtilde */
         memcpy(ptilde,rtilde,(size_t)parallel.alloc_vector3*sizeof(ldcomplex));
      }
      else{
...
/* 13. alpha=rhok/(ptilde^{T}q) */
      reduce=zero;
      for(index0i=0;index0i<parallel.alloc_vector3;index0i++){
         reduce=ldcomplex_add(reduce,ldcomplex_mul(ptilde[index0i],q[index0i]));
      }
