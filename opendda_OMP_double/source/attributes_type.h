...
/* Type definition for a structure to hold the target description
   ...
   double dipoles_per_wavelength; /* number of dipoles per wavelength */
   double dipole_spacing; /* inter-dipole spacing */
...
/* Type definition for a structure to control incident polarisation
   ...
   double n_inc[3]; /* Incident direction */
...
/* Type definition for a structure to control scattering vectors
   ...
   theta_sca: current scattering vector parallel to the
              scattering plane */
   double n_sca[3]; /* Scattering direction */
   double phi_sca[3]; /* Scattering vector perpendicular to the scattering plane */
   double theta_sca[3]; /* Scattering vector parallel to the scattering plane */
} attributes_scattering_vectors;
#endif
...
/* Type definition for a structure to control cross sections
   ...
   double extinction; /* Extinction cross section */
   double absorption; /* Absorption cross section */
   double scattering; /* Scattering cross section */
   double geometrical; /* Geometrical cross section */
} attributes_cross_sections;
#endif
...
/* Type definition for a structure to control efficiencies
   ...
   double extinction; /* Extinction efficiency */
   double absorption; /* Absorption efficiency */
   double scattering; /* Scattering efficiency */
