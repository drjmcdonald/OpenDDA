...
/* Rotate the incident vectors LF to TF */
   ...
   incident_TF.polarisation[0]=dcomplex_add(dcomplex_scale(incident_LF.polarisation[0],rotation[0]),
                                 dcomplex_scale(incident_LF.polarisation[1],rotation[1])); /* e0x in the target frame */
   incident_TF.polarisation[1]=dcomplex_add(dcomplex_scale(incident_LF.polarisation[0],rotation[3]),
                                 dcomplex_scale(incident_LF.polarisation[1],rotation[4])); /* e0y in the target frame */
   incident_TF.polarisation[2]=dcomplex_add(dcomplex_scale(incident_LF.polarisation[0],rotation[6]),
                                 dcomplex_scale(incident_LF.polarisation[1],rotation[7])); /* e0z in the target frame */
   ...
   incident_TF.orthonormal[0]=dcomplex_add(dcomplex_scale(incident_LF.orthonormal[0],rotation[0]),
                              dcomplex_scale(incident_LF.orthonormal[1],rotation[1])); /* e1x in the target frame */
   incident_TF.orthonormal[1]=dcomplex_add(dcomplex_scale(incident_LF.orthonormal[0],rotation[3]),
                              dcomplex_scale(incident_LF.orthonormal[1],rotation[4])); /* e1y in the target frame */
   incident_TF.orthonormal[2]=dcomplex_add(dcomplex_scale(incident_LF.orthonormal[0],rotation[6]),
                              dcomplex_scale(incident_LF.orthonormal[1],rotation[7])); /* e1z in the target frame */
...
|_ n_{sca}x     n_{sca}y     n_{sca}z _| |_cos(phi)sin(theta) sin(phi)sin(theta)  cos(theta)_| */
   ...
   cosphi=cos(degrees_to_radians(phi)); /* Convert phi to radians and calculate the cosine */
   sinphi=sin(degrees_to_radians(phi)); /* Convert phi to radians and calculate the sine */
   costheta=cos(degrees_to_radians(theta)); /* Convert theta to radians and calculate the cosine */
   sintheta=sin(degrees_to_radians(theta)); /* Convert theta to radians and calculate the sine */
   ...
   scattering_LF.phi_sca[2]=0.0; /* phi_{sca}z in the lab frame */
