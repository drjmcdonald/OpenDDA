...
/* Plan creation for the DFT of the tensor components */
      ...
      plan_tcydft=fftw_plan_many_dft(1,&target.Jpp,target.Ka,(fftw_complex *)(&interaction_matrix[0]),NULL,target.Ka,1,(fftw_complex *)(&interaction_matrix[0]),NULL,target.Ka,1,-1,FFTW_MEASURE);
