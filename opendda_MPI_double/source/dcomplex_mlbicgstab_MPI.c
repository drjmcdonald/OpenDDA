...
void dcomplex_mlbicgstab_MPI(void){

   int i,ii,s,t,vc,iteration=0;
   long int index0i,array0,array1,array2;
   dcomplex alpha,rho,tempdc,tempd,tempe,tempf,beta,reduce;
...
/* 13. zd=u,zg=0,zomega=0 */
         ...
         memcpy(zomega,zg,(size_t)parallel.alloc_vector3*sizeof(dcomplex));
...
/* tempf=q[ii]^{H}u */
         ...
         MPI_Allreduce(&reduce,&tempf,1,dcomplex_type,add_dcomplex,MPI_COMM_WORLD);
...
/* ->->->->->->->->->->->->->->->->->->->->->->->->->->->->->->->->->->->-> */
/* 27. g[ii-1]=zg */
         memcpy(&g[(ii-1)*parallel.alloc_vector3],zg,(size_t)parallel.alloc_vector3*sizeof(dcomplex));
...
/* 40. g[iterative.vec-1]=zg */
      memcpy(&g[(iterative.vec-1)*parallel.alloc_vector3],zg,(size_t)parallel.alloc_vector3*sizeof(dcomplex));
