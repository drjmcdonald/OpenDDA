...
extern dcomplex *interaction_matrix,*interaction_matrix_diagonal,*point_jacobi,*xdft,*zdft;
extern dcomplex *xzscratch,two,one,onei,zero,minusone;
...
extern MPI_Op add_dcomplex; /* User-defined MPI function to add complex_numbers */
/* Iterative vectors */
