...
void ldcomplex_mlbicgstab_ss_S(void){
   ...
   ldcomplex alpha,rho,tempdc,tempe,beta;
...
/* ->->->->->->->->->->->->->->->->->->->->->->->->->->->->->->->->->->->-> */
/* 3. g[0]=r */
      memcpy(g,r,(size_t)target.Nd3*sizeof(ldcomplex));
   }
...
/* 5. c[0]=q[0]^{H}omega[0] */
   c[0]=zero;
   for(index0i=0;index0i<target.Nd3;index0i++){
      c[0]=ldcomplex_add(c[0],ldcomplex_mul(ldcomplex_conj(q[index0i]),omega[index0i]));
   }
...
/* ->->->->->->->->->->->->->->->->->->->->->->->->->->->->->->->->->->->-> */
/* 9. zomega=r,zg=0 */
         memcpy(zomega,r,(size_t)target.Nd3*sizeof(ldcomplex));
         for(index0i=0;index0i<target.Nd3;index0i++){
            zg[index0i]=zero;
         }
...
/* tempe=q[ii]^{H}r */
         ...
         for(vc=0;vc<3;vc++){
            ...
            for(index0i=0;index0i<target.Nd;index0i++){
               tempe=ldcomplex_add(tempe,ldcomplex_mul(ldcomplex_conj(q[array1+index0i]),r[array0+index0i]));
            }
         }
...
/* ->->->->->->->->->->->->->->->->->->->->->->->->->->->->->->->->->->->-> */
/* 18. g[ii]=zg */
         memcpy(&g[ii*target.Nd3],zg,(size_t)target.Nd3*sizeof(ldcomplex));

/* ->->->->->->->->->->->->->->->->->->->->->->->->->->->->->->->->->->->-> */
/* 19. omega[ii]=zomega */
         memcpy(&omega[ii*target.Nd3],zomega,(size_t)target.Nd3*sizeof(ldcomplex));
...
/* 20. c[ii]=q[ii]^{H}zomega */
         ...
         for(vc=0;vc<3;vc++){
            ...
            array1=ii*target.Nd3+vc*target.Nd;
            for(index0i=0;index0i<target.Nd;index0i++){
               c[ii]=ldcomplex_add(c[ii],ldcomplex_mul(ldcomplex_conj(q[array1+index0i]),zomega[array0+index0i]));
            }
         }
      } /* End ii for loop */
...
/* 25. rho=(-[interaction_matrix*M^{-1}r]^{H}r)/(||interaction_matrix*M^{-1}r||^2)=
         ...
         tempdc=zero;
         for(index0i=0;index0i<target.Nd3;index0i++){
            tempdc=ldcomplex_add(tempdc,ldcomplex_mul(ldcomplex_conj(zomega[index0i]),zomega[index0i]));
         }
         /* Check for iterative.breakdown */
...
/* rho=[interaction_matrix*M^{-1}r]^{H}r */
         rho=zero;
         for(index0i=0;index0i<target.Nd3;index0i++){
            rho=ldcomplex_add(rho,ldcomplex_mul(ldcomplex_conj(zomega[index0i]),r[index0i]));
         }
...
/* 34. c[0]=q[0]^{H}zomega */
      c[0]=zero;
      for(index0i=0;index0i<target.Nd3;index0i++){
         c[0]=ldcomplex_add(c[0],ldcomplex_mul(ldcomplex_conj(q[index0i]),zomega[index0i]));
      }

/* ->->->->->->->->->->->->->->->->->->->->->->->->->->->->->->->->->->->-> */
/* 35. g[0]=zg,omega[0]=zomega */
      memcpy(g,zg,(size_t)target.Nd3*sizeof(ldcomplex));
      memcpy(omega,zomega,(size_t)target.Nd3*sizeof(ldcomplex));
      iteration++;
