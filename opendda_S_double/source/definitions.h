/* Written by James Mc Donald 2006
   ...
   plan_vczdft: FFTW plans for the DFT of the 3 zero-padded vector components
                in dftmatvec_S, zero_padded_vector[3][K*Jpp*P]
   plan_vcxdfti,
   plan_vcydfti,
   ...
   plan_tcxdft,
   plan_tcydft,
   plan_tczdft: FFTW plans for the DFT of the 6 tensor components in dftmatvec_S
                interaction_matrix[6][Ka*Ja*Pa]
   dpi: PI
...
#define dpi 3.14159265358979323846264338327950288419716939937510
extern int wl,er,f0,t0,p0,degree,dft_interaction_matrix_flag;
extern int polarisation_state,polarisations,DBLP;
extern double size_parameter,wavenumber,wavenumber_previous;
extern dcomplex *dipole_polarisation,*incident_E_field,*zero_padded_vector;
extern dcomplex *interaction_matrix,*interaction_matrix_diagonal,*point_jacobi;
extern dcomplex *xdft,*ydft,*zdft,*xzscratch,two,one,onei,zero,minusone;
extern fftw_plan plan_vcxdft,plan_vcydft,plan_vczdft,plan_vcxdfti,plan_vcydfti,plan_vczdfti;
extern fftw_plan plan_tcxdft,plan_tcydft,plan_tczdft;
...
/* Iterative vectors */
extern dcomplex *c,*d,*g,*gam,*gamp,*gampp,*gtilde,*omega,*omegatilde,*p,*pold,*ptilde,*q;
extern dcomplex *r,*rtilde,*s,*sigma,**tau,*u,*utilde,*v,*vtilde,*ya,*yb,*zd,*zg,*zomega;
