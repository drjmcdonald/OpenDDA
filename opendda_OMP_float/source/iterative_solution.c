...
/* Setup the iterative.preconditioner */
   ...
   if(strcmp(iterative.scheme,"bicg")==0){
      ...
      fcomplex_bicg_sym_OMP();
   }
   else if(strcmp(iterative.scheme,"bicgstab")==0){
      fcomplex_bicgstab_OMP();
   }
