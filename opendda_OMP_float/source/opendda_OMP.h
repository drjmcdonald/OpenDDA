...
int polarisation_state,polarisations,DBLP,FLTP,openmp_threads,threads_available;
float size_parameter,wavenumber,wavenumber_previous=-1.0F;
fcomplex *dipole_polarisation,*incident_E_field,*zero_padded_vector;
fcomplex *interaction_matrix,*interaction_matrix_diagonal,*point_jacobi;
fcomplex **xdft,**ydft,**zdft,**xzscratch,two={{2.0F,0.0F}},one={{1.0F,0.0F}};
fcomplex onei={{0.0F,1.0F}},zero={{0.0F,0.0F}},minusone={{-1.0F,0.0F}};
