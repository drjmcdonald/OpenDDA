/* Written by James Mc Donald 2006
   ...
   alpha,rho,minusone,
   tempdc,tempd,tempe,
   tempf,beta,real,imag,v0,v1: Local variables for iterative scheme
...
void fcomplex_mlbicgstab_OMP(void){

   int i,ii,s,t,vc,iteration=0;
   long int index0i,array0,array1,array2;
   fcomplex alpha,rho,tempdc,tempd,tempe,tempf,beta,v0,v1;
...
#pragma omp parallel for private(v0,v1) reduction(+:real,imag) schedule(dynamic,target.M)
         ...
         tempf.dat[0]=real;tempf.dat[1]=imag;
